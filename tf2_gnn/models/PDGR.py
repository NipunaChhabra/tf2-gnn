...
tfd = tf.keras.layers.Dense(5, input_shape=(30,), activation=None)

class PDGRTask(GraphTaskModel):
    @classmethod
    def get_default_hyperparameters(
        ...
        these_hypers: Dict[str, Any] = {
            ...
            "graph_aggregation_output_size": 15,
            "graph_aggregation_num_heads": 5,
            "graph_aggregation_layers": [32, 32],
            "graph_aggregation_dropout_rate": 0.1,
            "graph_representation_size": 15,
            "num_heads": 5,
        }
    ...
    def build(self, input_shapes):
        print("!!!!dims: ", self._params["gnn_hidden_dim"])
        ...
        node_to_graph_repr_input = NodesToGraphRepresentationInput(
            ...
            # What is the number of graphs????????Doubt!!!!!!
    ...
    def compute_task_metrics(
        ...
        mse = tf.losses.mean_squared_error(batch_labels["Label"], task_output)
        mae = tf.losses.mean_absolute_error(batch_labels["Label"], task_output)
